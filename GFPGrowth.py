...
class GFPGrowth(_ab._frequentPatterns):
    ...
    def startMine(self):
        ...
        print("Frequent patterns were generated from uncertain databases successfully using GFP algorithm")
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 5 or len(_ab._sys.argv) == 6:
        ...
        ap = GFPGrowth("PAKDD_Sample_uncertain.txt", 'PAKDD_neighbours.txt',  0.2, ' ')
        ap.startMine()
